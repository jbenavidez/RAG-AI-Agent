...
const (
	EmbeddingService_TextToEmbedding_FullMethodName = "/proto.EmbeddingService/TextToEmbedding"
)
...
type EmbeddingServiceClient interface {
	TextToEmbedding(ctx context.Context, in *EmbeddingsMessageRequest, opts ...grpc.CallOption) (*EmbeddingsMessageResponse, error)
}
...
func (c *embeddingServiceClient) TextToEmbedding(ctx context.Context, in *EmbeddingsMessageRequest, opts ...grpc.CallOption) (*EmbeddingsMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmbeddingsMessageResponse)
	err := c.cc.Invoke(ctx, EmbeddingService_TextToEmbedding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmbeddingServiceServer interface {
	TextToEmbedding(context.Context, *EmbeddingsMessageRequest) (*EmbeddingsMessageResponse, error)
...
func (UnimplementedEmbeddingServiceServer) TextToEmbedding(context.Context, *EmbeddingsMessageRequest) (*EmbeddingsMessageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TextToEmbedding not implemented")
}
...
func _EmbeddingService_TextToEmbedding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmbeddingsMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmbeddingServiceServer).TextToEmbedding(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmbeddingService_TextToEmbedding_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmbeddingServiceServer).TextToEmbedding(ctx, req.(*EmbeddingsMessageRequest))
	}
...
var EmbeddingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "TextToEmbedding",
			Handler:    _EmbeddingService_TextToEmbedding_Handler,
		},
	},
